...
/// <summary>
/// Concrete state class contianing the player's sprint logic.
/// </summary>
public class PlayerSprintState : PlayerBaseState
{
    /// <summary>
    /// Constructor for the PlayerSprintState. Passes currentContext and
    ...
    public PlayerSprintState(PlayerStateMachine currentContext,
    ...
    {
        Context.CurrentSpeedMultiplier = Context.SprintSpeedMultiplier;
    }
